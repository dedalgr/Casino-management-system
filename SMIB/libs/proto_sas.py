...
class Sas():
    ...
    def __init__(self, port, timeout=2, log=None, poll_adress=0x82, aft_check_last_transaction=True, sas_dump=False, denom=0.01, lock_time=0, get_aft_transaction_from_EMG=False,):
        # self.poll_adres = '82'
        self.adress = None
        self.mashin_n = None
