...
if __name__ == '__main__':
    pg = PostgresqlCtrl('mistralcms', 'use_system10', 'mistralcms', scoped=True)
    Base = declarative_base(pg.session)
    import threading
    ...
    def a():
        while True:
            pg = PostgresqlCtrl('mistralcms', 'use_system10', 'mistralcms')
            pg.make_session()
            print(pg.get_all(Alembic)[0].version_num, 'a')
            pg.close()
    def b():
        while True:
            pg = PostgresqlCtrl('mistralcms', 'use_system10', 'mistralcms')
            pg.make_session()
            print(pg.get_all(Alembic)[0].version_num, 'b')
            pg.close()
    ...
    while True:
        pg = PostgresqlCtrl('mistralcms', 'use_system10', 'mistralcms')
        pg.make_session()
        print(pg.get_all(Alembic)[0].version_num, 'c')
        pg.close()
