...
class SubVersion():
    ...
    def cleanup(self):
        self.client.cleanup(path=self.folder)
    ...
    def update(self, rev=None):
        if rev == None:
            self.client.update(self.folder)
            return self.info()
        else:
...
if __name__ == '__main__':
    svn = SubVersion('/home/dedal/Colibri/SMIB', 'svn://NEW_SVN_IP/home/svn/SMIB/1_2', 'dedal', 'Vavilon10')
    print(svn.checkout())
    print(svn.update())
