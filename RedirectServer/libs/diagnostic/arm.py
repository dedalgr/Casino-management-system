...
class OlimexMicro():
    ...
    def temp():
        ...
        data = open('/sys/devices/platform/sunxi-i2c.0/i2c-0/0-0034/temp1_input').read()
    ...
    def voltage():
        ...
        data = open('/sys/bus/i2c/devices/0-0034/axp20-supplyer.28/power_supply/ac/voltage_now').read()
        # data = os.popen(cmd).read()
    ...
    def amper():
        ...
        data = open('cat /sys/bus/i2c/devices/0-0034/axp20-supplyer.28/power_supply/ac/current_now').read()
        # data = os.popen(cmd).read()
